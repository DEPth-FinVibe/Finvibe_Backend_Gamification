...
import depth.finvibe.gamification.modules.study.application.port.in.AiStudyRecommendCommandUseCase;
import depth.finvibe.gamification.modules.study.application.port.in.AiStudyRecommendQueryUseCase;
import depth.finvibe.gamification.modules.study.application.port.out.AiRecommendGenerator;
import depth.finvibe.gamification.modules.study.application.port.out.AiStudyRecommendRepository;
import depth.finvibe.gamification.modules.study.application.port.out.TradeServiceClient;
import depth.finvibe.gamification.modules.study.domain.AiStudyRecommend;
